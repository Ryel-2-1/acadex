...
<head>
    ...
    <style>
        ...
        .header-icon {
            font-size: 48px;
            color: #1a73e8; /* Matches the blue in the logo */
            margin-bottom: 10px;
        }
        ...
        .input-group input {
            width: 100%;
            padding: 12px 15px 12px 45px; /* Left padding makes room for icon */
        ...
        .btn-primary {
            width: 100%;
            background-color: #2b7ae0; /* Primary Blue */
            color: white;
            border: none;
            padding: 12px;
            border-radius: 8px;
...
<body>
    ...
    <div class="login-container">
        ...
        <div class="login-card">
            <form onsubmit="event.preventDefault()"> <label for="email">Email Address</label>
                <div class="input-group">
                    <i class="fa-regular fa-envelope"></i>
                    <input type="email" id="email" placeholder="Sample@pup.edu">
                </div>
                ...
                <button class="btn-secondary">Go to Student Login</button>
