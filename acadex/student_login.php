...
<head>
    ...
    <style>
        ...
        .btn-primary { width: 100%; background-color: #00C060; color: white; border: none; padding: 12px; border-radius: 8px; font-size: 16px; font-weight: 600; margin-top: 20px; cursor: pointer; }
...
<body>
    <div class="login-container">
        <div class="header-content"><i class="fa-solid fa-graduation-cap header-icon"></i><h1>Student Portal</h1><p class="subtitle">Sign in to view your classes.</p></div>
